...
const BookCard = ({ 
  ...
  return (
    <div
      className={`cursor-pointer flex flex-col items-center transition-all duration-300 group book-card-dark ${className}`}
      onClick={handleClick}
    >
      {/* Book Cover with 3D effect */}
      <div className="w-full mb-3 max-w-[200px] group-hover:transform group-hover:scale-105 transition-all duration-300">
        <NovelCover 
